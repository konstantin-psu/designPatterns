...
public class Main {
	...
	pattpack.ast_vis3.PrintVisitor pv = new pattpack.ast_vis3.PrintVisitor (System.out);
	pv.visit (factorial, new Integer (0));
	System.out.println ();
	System.out.println ();
	pattpack.ast_vis3.InterpretVisitor iv = new pattpack.ast_vis3.InterpretVisitor ();
	iv.visit (factorial, null);
    }
}
